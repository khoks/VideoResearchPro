...
- [`/knowledge-curator`](.claude/skills/knowledge-curator/SKILL.md) — extracts vision / architecture / tech-stack / scaling / decision content from the conversation and routes it into the canonical docs (`docs/feature-roadmap.md`, `docs/architecture.md`, `docs/source-types.md`, `docs/decisions.md`, etc.). Owns the [decision log](docs/decisions.md).
