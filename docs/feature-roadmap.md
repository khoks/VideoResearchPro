...
- 🟡 **Milestone M-1.5 (Reddit + HN end-to-end) in flight.** 3 of 7 component checks closed (C1 cutover, C3 storage, C4 classifier persistence). Remaining: orchestrator wiring (S-1.5.11 T-1.5.11.2-.4 + integration into `execute_topic_job`), polymorphic ApprovalCard primitive (S-1.5.4 T-1.5.4.3-.5), citation rendering (S-1.5.5), and e2e pipeline tests (T-1.5.11.5/.6/.7).
