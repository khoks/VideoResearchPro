...
- 🔵 **Next: E-1.10 (UUID PK promotion) before storage wiring.** Per [D-015](decisions.md#d-015--promote-e-110-uuid-pk-ahead-of-reddit--hn-orchestrator-wiring-2026-04-26), promote `documents.video_id` → `document_id UUID` + a separate `source_id text` column with `(source_type, source_id)` unique index *before* wiring Reddit / HN orchestrator dispatch. This avoids a two-wave migration (prefixed-string PK followed by UUID cutover); Reddit + HN storage tasks become trivial inserts on the new schema.
- 🔵 **Then: social-media orchestrator + storage wiring (E-1.5 continuation).** Per [D-005](decisions.md#d-005--social-media-ingest-before-article-ingest-2026-04-25), ahead of the article connector. Stages: **Reddit + HN orchestrator dispatch first** (connector code already on master), then Mastodon + Bluesky, then Mode B paste mode covering FB / IG / LI / X-without-paid-API, then BYOK Twitter API ([D-009](decisions.md#d-009--twitter--x-is-byok--opt-in-2026-04-25)). Discord and TikTok deferred ([D-010](decisions.md#d-010--defer-tiktok-and-per-server-discord-bot-indefinitely-2026-04-25)). One `Document` per thread ([D-006](decisions.md#d-006--one-document-row-per-social-post-thread-not-per-comment-2026-04-25)); fetch-time stance / sentiment / **framing** classification ([D-007](decisions.md#d-007--sentiment--stance-classification-at-fetch-time-2026-04-25) + [D-014](decisions.md#d-014--add-framing-axis-to-social_classify_stance-schema-2026-04-26)); no scraping of search-result pages ([D-008](decisions.md#d-008--no-scraping-of-search-result-pages-on-fb--ig--linkedin-2026-04-25)); approval surface uses the **single polymorphic `<ApprovalCard>`** ([D-016](decisions.md#d-016--single-polymorphic-approval-card-driven-by-source_metadata-2026-04-26)). Detailed shape: [`source-types.md` § Social-media post specifics](source-types.md#social-media-post-specifics).
