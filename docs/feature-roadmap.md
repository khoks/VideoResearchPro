...
- 🟢 **Foundation (PRs #63 / #65 / #66 / #67, shipped 2026-04-22 → 04-25).** Schema additive columns; `BaseConnector` interface; routed call sites; `videos` → `documents` table + ORM rename. See [`initiatives.md`](initiatives.md#i-1-multi-source-ingest-closed-2026-05-03) for the full E-1.1 → E-1.4 trace.
